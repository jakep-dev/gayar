...
import { SeverityIncidentBarModel, BarChartData, SeverityInput, ComponentPrintSettings } from 'app/model/model';
...
export class IncidentBarComponent implements OnInit {
	...
	public modelData: SeverityIncidentBarModel;

	private setModelData(modelData: SeverityIncidentBarModel) {
