...
export class SeverityIncidentPieDirective {
  
    @Input() modelData: SeverityIncidentPieFlipModel;
        ...
        if (this.modelData) {
          let tempChartData: PieChartData = {
            ...
            customChartSettings: {
              ...
              colors:[
                SeverityIncidentPieDirective.BLUE , //'#487AA1'
                SeverityIncidentPieDirective.GREEN, //'#B1D23B'
                SeverityIncidentPieDirective.CYAN, //'#27A9BC'
                SeverityIncidentPieDirective.ORANGE, //'#F68C20'
                SeverityIncidentPieDirective.DGRAY, //'#464646'
                SeverityIncidentPieDirective.LGRAY, //'#CCCCCC'
              ],
              legend: {
                align: 'right',
                verticalAlign: 'top',
