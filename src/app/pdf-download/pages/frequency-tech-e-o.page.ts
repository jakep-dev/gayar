...
export class FrequencyTechEOPage extends BasePage  {

    //page type name for this page
    public static pageType:string = 'FrequencyTechEOPage';

    //default page prefix of this page to prevent json object names from one page don't clash with other pages
    private prefix: string = FrequencyTechEOPage.pageType + '_';
