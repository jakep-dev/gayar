...
export class SeverityTimePeriodPage extends BasePage  {
    ...
    public static pageType:string = 'SeverityTimePeriodPage';

    //default page prefix of this page to prevent json object names from one page don't clash with other pages
    private prefix: string = SeverityTimePeriodPage.pageType + '_';
    ...
    public getPageType(): string {
        return SeverityTimePeriodPage.pageType;
    }
            ...
            switch(index) {
                ...
                case 1:
                    if(this.hasDetailChartPermission) {
                        ...
                        this.table.table.body[2][index].columns[0].text = '';
                    }
                    break;
