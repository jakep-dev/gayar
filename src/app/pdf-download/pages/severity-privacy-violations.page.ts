...
export class SeverityPrivacyViolationsPage extends BasePage  {

    public static pageType:string = 'SeverityPrivacyViolationsPage';

    private prefix: string = SeverityPrivacyViolationsPage.pageType + '_';
    ...
    public getPageType(): string {
        return SeverityPrivacyViolationsPage.pageType;
    }
